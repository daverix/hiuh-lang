...
sätt är del av till infixgrej med del som heltal, helhet som lista av heltal ger boolesk
    ge FALSKT"""
        expected = [AssignNode(None, None, name='är del av', value=FunctionDefNode(None, None, params=[('del', 'heltal'), ('helhet', 'lista av heltal')], body=[ReturnNode(None, None, value=ExpressionPartsNode(None, None, parts=[ExpressionPart('FALSKT', TOKEN_LITERAL_FALSE)]))], is_infix=True, return_type='boolesk'))]
        self.assertParseEqual(source, expected)
...
sätt upprepa till verbgrej med ord som sträng, antal som heltal ger sträng
    ge ord"""
        expected = [AssignNode(None, None, name='upprepa', value=FunctionDefNode(None, None, params=[('ord', 'sträng'), ('antal', 'heltal')], body=[ReturnNode(None, None, value=ExpressionPartsNode(None, None, parts=[ExpressionPart('ord', TOKEN_IDENTIFIER)]))], is_infix=False, return_type='sträng'))]
        self.assertParseEqual(source, expected)
...
sätt lägg_till till skickagrej med sak som sträng, mål som lista av sträng ger lista av sträng
    ge mål"""
        expected = [AssignNode(None, None, name='lägg_till', value=FunctionDefNode(None, None, params=[('sak', 'sträng'), ('mål', 'lista av sträng')], body=[ReturnNode(None, None, value=ExpressionPartsNode(None, None, parts=[ExpressionPart('mål', TOKEN_IDENTIFIER)]))], is_infix=False, return_type='lista av sträng'))]
        self.assertParseEqual(source, expected)
